...
import { Z_INDEXES } from "@barcode/types/enum/zIndex";
import { useAppDispatch, useAppSelector } from "@barcode/state/hooks";
import { Theme } from "@barcode/types/enum/Theme";
import { selectTheme, setTheme } from "@barcode/state/reducer/ThemeReducer";
...
export const Header: React.FC = () => {
  ...
  return (
    <View style={[styles.container, themeStyles.lightContainer]}>
      <Link href={"/"}>
        <Text style={styles.logoText}>barcode</Text>
      </Link>
